$('#btn3').click(function () {
    let valueInputFulfillment = $('#FulfillmentEmulationin').val();
    let valueInputWarnings = $('#WarningsEmulationin').val();
    var visibilityBody = $('.cashInBody');
    var visibilityBorder = $('.cashInBorder');
    var Interest = $(".cashInText");
    ...
    if (valueInputFulfillment < valueInputWarnings) {
        if (valueInputFulfillment == 0 ) {
            ...
            visibilityBody.css('background-color', '#1b2559');
             visibilityBorder.css('border','2px solid #1b2559');
